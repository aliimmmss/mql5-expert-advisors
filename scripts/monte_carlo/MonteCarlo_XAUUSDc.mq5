...
#property description "Monte Carlo Risk Assessment for XAUUSDc (HFM Cent Account)"
#property description "Optimized for $50/month = 5,000 USC balance"
...
input double   InpInitialBalance = 5000.0;            // Starting account balance (USC)
input double   InpRuinThreshold  = 0.15;             // Ruin threshold (15% = 750 USC loss)
...
input bool     InpSlippageEnabled = true;             // [Slippage] Enable commission/slippage sim
input double   InpCommission      = 1.5;             // [Slippage] HFM commission per trade (USC)
input double   InpSlippageMax     = 2;               // [Slippage] Max random slippage per trade (USC)
